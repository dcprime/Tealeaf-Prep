...
while bottles.to_i > 1
  puts english_number(bottles.to_i).capitalize + ' bottles of beer on the wall!'
  puts english_number(bottles.to_i).capitalize + ' bottles of beer!'
  ...
  if bottles.to_i > 1
    ...
    puts english_number(bottles.to_i).capitalize + ' bottle of beer on the wall!'
    puts ''
  end
end
puts english_number(bottles.to_i).capitalize + ' bottle of beer on the wall!'
puts english_number(bottles.to_i).capitalize + ' bottle of beer!'
puts 'You take one down, pass it around,'
